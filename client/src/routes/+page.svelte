...
<main class="relative flex flex-col items-center justify-center h-screen overflow-hidden">
    <!-- Animated gradient background -->
    <div class="absolute inset-0 bg-gradient-to-br from-purple-600 via-blue-500 to-green-400 animate-gradient"></div>
    
    <!-- Floating circles for added visual interest -->
    <div class="absolute top-1/4 left-1/4 w-96 h-96 bg-white/10 rounded-full mix-blend-multiply filter blur-xl animate-blob"></div>
    <div class="absolute top-1/3 right-1/4 w-96 h-96 bg-pink-300/10 rounded-full mix-blend-multiply filter blur-xl animate-blob animation-delay-2000"></div>
    <div class="absolute bottom-1/4 left-1/3 w-96 h-96 bg-yellow-200/10 rounded-full mix-blend-multiply filter blur-xl animate-blob animation-delay-4000"></div>

    <h1 class="text-6xl font-bold mb-8 text-white drop-shadow-lg z-10">Ponzi Land</h1>
    <button 
        on:click={startGame}
